...
function submitComment() {
	if (localStorage.getItem('authorization')) {
		$.ajax({
			...
			crossDomain: true,
			data: '{"article_id":5, "text": "' + document.getElementById('comments').value  +'"}',
			dataType: 'json',
		...
		localStorage.setItem('referenceLink', 'file:///J:/Takani/Takani_blog/page/page_5.html');
...
$.ajax({
	...
	type: 'GET',
	url: 'http://52.26.206.29:3000/comments?article_id=5&limit=10&offset=0',
	crossDomain: true,
	dataType: 'json',
